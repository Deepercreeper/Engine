package org.deepercreeper.engine.geometry;
...
public class RectangleTest
{
    ...
    {
        Rectangle subtrahend = new Rectangle().setWidth(5).setHeight(5);
        Rectangle minuend = new Rectangle();
    ...
    {
        Rectangle box = new Rectangle().setWidth(2).setHeight(2);
    ...
    {
        Rectangle rectangle = new Rectangle().setWidth(2).setHeight(2);
    ...
    {
        Rectangle firstRectangle = new Rectangle().setWidth(2).setHeight(2);
        Rectangle secondRectangle = new Rectangle().setX(2).setWidth(2).setHeight(2);
    ...
    {
        Rectangle firstRectangle = new Rectangle().setWidth(2).setHeight(2);
        Rectangle secondRectangle = new Rectangle().setX(2).setY(2).setWidth(2).setHeight(2);
