...
public class BoxTest
{
    ...
    {
        Box box = new Box().setWidth(2).setHeight(2);
    ...
    {
        Box firstBox = new Box().setWidth(2).setHeight(2);
        Box secondBox = new Box().setX(2).setWidth(2).setHeight(2);
    ...
    {
        Box firstBox = new Box().setWidth(2).setHeight(2);
        Box secondBox = new Box().setX(2).setY(2).setWidth(2).setHeight(2);
    ...
    {
        Box box = new Box().setX(1).setY(1).setWidth(2).setHeight(2);
    ...
    {
        Box firstBox = new Box().setWidth(1).setHeight(1);
        Box secondBox = new Box().setX(2).setY(2).setWidth(1).setHeight(1);
