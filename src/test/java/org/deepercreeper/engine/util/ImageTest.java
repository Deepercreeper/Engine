...
public class ImageTest {
    ...
    public void testWrongLengthValidation() {
        Image image = new Image().setWidth(10).setHeight(1).setData(new int[15]);
    ...
    public void testValidation() {
        Image image = new Image().setWidth(10).setHeight(1).setData(new int[10]);
    ...
    public void testDrawOver() {
        Image firstImage = new Image().setWidth(10).setHeight(10).setData(new int[100]);
        Image secondImage = new Image().setWidth(2).setHeight(2).setData(Display.createFilledRectangle(2, 2, 0xffffffff));
